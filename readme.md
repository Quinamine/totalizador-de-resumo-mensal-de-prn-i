...
O **Totalizador de Resumo Mensal de PRN I** é um serviço online gratuito que auxilia na elaboração, como o nome sugere, do resumo mensal de PRN I (Programa de Reabilitação Nutricional para Crianças dos 6 aos 14 anos), por meio do cálculo automático dos totais com base nos dados preenchidos pelo usuário. Foi criado de acordo com o modelo da ficha de resumo mensal de PRN I actualmente vigente no Serviço Nacional de Saúde em Moçambique.
...
* Ter colhido os dados de todos os indicadores da ficha nas fontes primárias (livro(s) de registo de PRN para pacientes dos 0 aos 14 anos) da sua Unidade Sanitária.
